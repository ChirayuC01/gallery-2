...
const MyCuteClips = () => {
  const videoTitles = [
    "Rana @ 13 months (May 24)",
    "Rana @ 14 months (June 24)",
    "Rana @ 15 months (July 24)",
    "Rana @ 16 months (August 24)",
    "Rana @ 17 months (September 24)",
    "Rana @ 18 months (October 24)",
    "Rana @ 19 months (November 24)",
    "Rana @ 20 months (December 24)",
    "Rana @ 21 months (January 25)",
    "Rana @ 22 months (February 25)",
    "Rana @ 23 months (March 25)",
  ];
                ...
                >
                  ...
                  >
                    <div className="relative pt-2 px-2">
                      ...
                      >
                        <source
                          src={`https://ranajainwebsite.blob.core.windows.net/home/rana-is-two/${encodeSpaces(
                            "Rana @ 13 months (May 24)"
                          )}.mp4`}
                          type="video/mp4"
                        />
